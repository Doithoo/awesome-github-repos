...
*   [Yalums/lyra-exporter](https://github.com/Yalums/lyra-exporter) - 开源的多AI平台对话管理导出的React应用，支持 Claude、Gemini、NotebookLM、Google AI Studio 等主流平台。正在完善移动端与Claude完整导出的支持，逐渐适配更多平台中。配套脚本: https://greasyfork.org/zh-CN/scripts/539579-lyra-s-exporter-fetch
