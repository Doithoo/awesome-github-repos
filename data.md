...
*   [Yalums/lyra-exporter](https://github.com/Yalums/lyra-exporter) - 这是一款开源的多平台 AI 对话管理与导出的React应用，支持 Claude、Gemini、NotebookLM、Google AI Studio 等主流平台，目前正在逐渐适配更多平台与完善移动端的支持情况。配套脚本: https://greasyfork.org/zh-CN/scripts/539579-lyra-s-exporter-fetch
