...
*   [alephpi/Texo](https://github.com/alephpi/Texo) - A minimalist SOTA LaTeX OCR model which contains only 20M parameters and runs in browser. Containing full training pipeline suitable for self-study. | 超轻量SOTA LaTeX公式识别模型，20M参数量，可在浏览器中运行。包含训练全流程代码，适合自学。
